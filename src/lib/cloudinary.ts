...
export const FALLBACK_MEMORIES: MemoryPhoto[] = [
  {
    ...
    caption: "Tech Keynote & Symposium",
    rotation: -6,
    x: -120,
    y: 20,
  },
  {
    ...
    caption: "Builder Community & Collaboration",
    rotation: 5,
    x: 140,
    y: 30,
  },
  {
    ...
    caption: "Hackathon Building Sprint",
    rotation: -3,
    x: -50,
    y: -20,
  },
